            ...
            <Routes>
              <Route element={<PrivateRoutes />}>
                <Route
                  exact
                  path="/"
                  element={<Dashboard measure={sideBarDisplay} />}
                />
                {/* <Route path="/user" element={<Users measure={sideBarDisplay}/>} /> */}
                <Route
                  path="/bookings"
                  element={<Bookings measure={sideBarDisplay} />}
                />
                <Route
                  path="/bookings/:id"
                  element={<BookingsDetails measure={sideBarDisplay} />}
                />
                <Route
                  path="/rooms"
                  element={<Rooms measure={sideBarDisplay} />}
                />
                {/* <Route path="/room/:id" element={<Room/>} /> */}
                <Route
                  path="/users"
                  element={<Users measure={sideBarDisplay} />}
                />
                <Route
                  path="/contact"
                  element={<Contact measure={sideBarDisplay} />}
                />
              </Route>
